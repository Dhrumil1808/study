    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          ...
          <td colspan="3"><input name="productinfo" type="hidden" value="<?php echo (empty($posted['productinfo'])) ? '' : $posted['productinfo'] ?>"> </td>
        </tr>
        <tr>
          
          <td colspan="3"><input name="surl" type="hidden" value="<?php echo (empty($posted['surl'])) ? '' : $posted['surl'] ?>" size="64" /></td>
        </tr>
        <tr>
          
          <td colspan="3"><input name="furl" type="hidden" value="<?php echo (empty($posted['furl'])) ? '' : $posted['furl'] ?>" size="64" /></td>
        </tr>
