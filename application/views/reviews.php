    ...
    <div class="container" id = "heading">
        <div class="col-md-3">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="/CodeIgniter_2.2.0/index.php/my_account/reviews">Ratings and Reviews</a></li>
        ...
        <div class="col-md-9">
            <div class="panel panel-info" >
                ...
                <?php 
                    while($review=mysql_fetch_object($reviews))
                    {
                        $this->load->database();
                        $sql = "SELECT * FROM materials WHERE Material_ID = '$review->Material_ID'";
                        $result = mysql_query($sql);
                        $material=mysql_fetch_object($result);
                ?>
                      <div class="panel-body" id = "panel_body1">  
                        <fieldset>
                        <legend><?php echo $material->Material_Name; ?></legend>
                        <div class="form-group">
                          <label class="col-lg-2 control-label">Image</label>
                          
                          <div class="col-lg-10">
                            <div class="thumbnail">
                            <img src="http://localhost/CodeIgniter_2.2.0/<?php echo $material->Image;?>" height="100" width="100">
                            </div>
                        ...
                        <div class="form-group">
                        <label for="contactInput" class="col-lg-2 control-label">Rating</label>
                            <div class="col-lg-10">
                                <?php echo "0".$review->Rating; ?>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="col-lg-10">
                            <a href="/CodeIgniter_2.2.0/index.php/my_account/review_remove/?id=<?php echo $review->Material_ID; ?>&email=<?php echo $review->Student_Email; ?> "> <h6> DELETE </h6></a>
                          </div>
                        </div>
                        </fieldset>
                      </div>
