    ...
    <?php echo validation_errors(); ?>
        <form role="form" method="POST">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <div class="form-group">
                    <label for="ConfirmEmail">Stream</label>
                    <div class="input-group">
                        <select name='stream' class="form-control" id="InputName">
                ...
                <div class="form-group">
                    <label for="InputMessage">Current Address</label>
                    <div class="input-group">
                        <textarea name="address" id="InputMessage" class="form-control" rows="5" ></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <select name='state' class="form-control" id="InputName">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="InputContact" name="pincode" placeholder="Enter Pincode" maxlength="6" >
                        <span class="input-group-addon"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label for="InputEmail"> Bank AccountNumber</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="InputContact" name="accnum" placeholder="Enter Bank AccountNumber" maxlength="10" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                        <input type="text" class="form-control" name="bname" id="InputName" placeholder="Enter Business Name" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
