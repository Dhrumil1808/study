...
<body>
    ...
    <?php
        $this->load->database(); 
        $sql = "SELECT users.Name, users.Username, users.Email, users.Contact, vendor.BusinessName FROM users,vendor WHERE (users.Name LIKE '%{$search}%' OR users.Username LIKE '%{$search}%' OR users.Email LIKE '%{$search}%' OR vendor.BusinessName LIKE '%{$search}%') AND users.Email = vendor.Email ";
        ...
        <div class="container">
            <div class="list-group">
                <?php 
                    ...
                    {
                ?>
                        <a href="http://localhost/CodeIgniter_2.2.0/index.php/admin_home/view_vendor?Username=<?php echo $user->Username; ?>" class="list-group-item" >
                        <h4 class="list-group-item-heading">Username: <?php echo $user->Username; ?></h4>
                        <p class="list-group-item-text">Name: <?php echo $user->Name; ?> </br> Email: <?php echo $user->Email; ?> </br> Business Name: <?php echo $user->BusinessName; ?> </br>Contact: <?php echo $user->Contact; ?></p>
                        </a>
                <?php
                    }
                ?>
