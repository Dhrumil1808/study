        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                <img class="profile-img" src="https://lh5.googleusercontent.com/-b0-k99FZlyE/AAAAAAAAAAI/AAAAAAAAAAA/eu7opA4byxI/photo.jpg?sz=120"
                    alt="">
                <form method="POST" class="form-signin" action="match_vendor_data">
            ...
            <a href="/CodeIgniter_2.2.0/index.php/signup/take_vendor_entries" class="text-center new-account">Create a new vendor account </a>
        </div>
    </div>
</div>
