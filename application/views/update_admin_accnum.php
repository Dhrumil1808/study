    ...
    <div class="container" id = "heading">
        <div class="col-md-3">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="/CodeIgniter_2.2.0/index.php/my_account/edit_admin_password">Change Password</a></li>
                <li><a href="/CodeIgniter_2.2.0/index.php/my_account/edit_admin_Email">Change Email</a></li>
                <li class="active"><a href="/CodeIgniter_2.2.0/index.php/my_account/edit_admin_accnum">Change Account Number</a></li>
        ...
        <div class="col-md-9">
            <div class="panel panel-info" >
                ...
                <div class="panel-body" id = "panel_body1">  
                        <fieldset>
                        <legend>Change Account Number</legend>
                        <div class="form-group">
                          <label class="col-lg-2 control-label">Account_Number</label>
                          
                          <div class="col-lg-10"><?php echo $accnum->AccountNumber; ?>
                          <span class="help-block"></span>
                            <!--<input type="text" class="form-control" id="nameInput" placeholder="Update Username">-->
                          </div>
                        </div>
                        <div class="form-group">
                        <label for="contactInput" class="col-lg-2 control-label">New Account Number</label>
                            <div class="col-lg-10">
                                <input type="text" name="new_accnum" class="form-control" id="contactInput">
                            </div>
                        </div>
