    ...
    <div class="container" id = "heading">
        <div class="col-md-3">
            <ul class="nav nav-pills nav-stacked">
                <li><a href="/CodeIgniter_2.2.0/index.php/my_account/vendor_account">Personal Info</a></li>
                <li class="active"><a href="/CodeIgniter_2.2.0/index.php/my_account/update_business_info">Business Info</a></li>
        ...
        <div class="col-md-9">
            <div class="panel panel-info" >
                ...
                <div class="panel-body" id = "panel_body1">  
                        ...
                        <label for="inputEmail" class="col-lg-2 control-label">Business_Name</label>
                            <div class="col-lg-10">
                                <input type="text" name="bname" class="form-control" id="inputName" value="<?php echo $vendor_info->BusinessName; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                          <label for="contactInput" class="col-lg-2 control-label">Account_Number</label>
                          <div class="col-lg-10">
                            <input type="text" name="accnum" class="form-control" id="contactInput" value="<?php echo $vendor_info->AccountNumber; ?>">
                          </div>
                        </div>
