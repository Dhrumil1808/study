    ...
    <div class="container" id = "heading">
        ...
        <div class="col-md-9">
            <div class="panel panel-info" >
                ...
                <form class="form-horizontal" method="POST" action="insert_category" enctype="multipart/form-data" >
                <input type="hidden" name="MAX_FILE_SIZE" value="1000000" />  
                        <fieldset>
                        <legend></legend>
                        <div class="form-group">
                            <div class="row">
                                <label for="nameInput" class="col-lg-2 control-label">New_Category</label>
                                <div class="col-lg-6">
                ...
                <form class="form-horizontal" method="GET" action="add_category" enctype="multipart/form-data" >
                    <input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
                    <fieldset>
                        <legend></legend>
                    <div class="form-group">
