...
<body>
    ...
    <div class="container" id = "heading">
      ...
      <div class="red"><?php echo validation_errors(); ?> </div>
        ...
        <form class="form-horizontal" method="post" id="shipping" action="cod_cart" >  
            <fieldset>
  ...
  if(isset($_GET['msg1']))
{
           ...
           $date=date("Y-m-d H:i:s");
            ...
            $email=$_GET['msg1'];
        $select_cart="SELECT * FROM cart WHERE cart.Student_Email = '$_GET[msg1]'";
        //echo $select_cart;
        ...
        <td> <?php  $r->Quantity;
                        $t_quantity+=$r->Quantity; ?> </td>
        <td> <?php  ($row->Price)* $r->Quantity; ?> </td>
        <td> <?php  $row->Discount * ($r->Quantity); ?> </td>
        <td> <?php  $row->FinalPrice* ($r->Quantity);
...
else
{
          $time_zone=date_default_timezone_set("Asia/Kolkata");
           $date=date("Y-m-d H:i:s");
            ...
            //$email=$_GET['msg1'];
        $select_cart="SELECT * FROM cart WHERE cart.Student_Email = '$email'";
        //echo $select_cart;
        $result_cart=mysql_query($select_cart);
        $sum=0;
        $t_quantity=0;
     ...
     if(isset($_GET['msg1']))
   {
    ...
    $time_zone=date_default_timezone_set("Asia/Kolkata");
           $date=date("Y-m-d H:i:s");
            ...
            $email=$_GET['msg1'];
        $select_cart="SELECT * FROM cart,users WHERE cart.Student_Email = '$_GET[msg1]' AND email='$_GET[msg1]'";
        //echo $select_cart;
        $result_cart=mysql_query($select_cart);
...
<input type="hidden" name="date" value="<?php echo $data['quantity']; ?>"> 
        ...
        <tr>
            ...
            <td colspan="4"><input type="submit" formaction="online_payment_cart" name="online_submit" id="online_payment"  class="btn btn-primary" value="Place order"></td> 
  ...
  <div method="post" name="payuForm" id="gateway" style="display:none">
    ...
    $time_zone=date_default_timezone_set("Asia/Kolkata");
           ...
           //echo $date;
            ...
            //$email=$_GET['msg1'];
        $select_cart="SELECT * FROM cart,users WHERE cart.Student_Email = '$email' AND email='$email'";
        //echo $select_cart;
        $result_cart=mysql_query($select_cart);
...
<input type="hidden" name="quantity" value="<?php echo $t_quantity;?>">
 ...
 <input type="hidden" name="date" value="<?php echo $data['quantity']; ?>"> 
        ...
        <tr>
            ...
            <td colspan="4"><input type="submit" formaction="online_payment_cart" name="online_submit"  class="btn btn-primary" value="Place order"></td> 
...
<?php
      ...
      ?>    
            <a href="payment_cart"><input type="submit" name="nothing" class="btn btn-primary" id="none" value="Place Order"></a>
            <div class="red"> 
              <?php
